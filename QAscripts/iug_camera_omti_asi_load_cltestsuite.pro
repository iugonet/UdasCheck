...
;2 single site
;
; iug_load_camera_omti_asi,site='drw'
;
;3 multi sites string
;
; iug_load_camera_omti_asi,site='sgk drw'
;
;4 multi sites array
;
; iug_load_camera_omti_asi,site=['sgk', 'sta', 'yng', 'drw']
;
;5 caps site
;
; iug_load_camera_omti_asi,site=['DRW']
...
;6 load all sites
;
; iug_load_camera_omti_asi,site='all'
;
;7 load * sites
;
; iug_load_camera_omti_asi,site='*'
;
;8 single wavelength
;
; iug_load_camera_omti_asi, wavelength='6300', site='drw'
;
;9 multi wavelengths string
;
; iug_load_camera_omti_asi, wavelength='5577 6300', site='drw'
;
;10 array wavelength
;
; iug_load_camera_omti_asi, wavelength=['5577', '6300'], site='drw'
...
;11 /downloadonly
;
; iug_load_camera_omti_asi, site='drw', /downloadonly
;
;12 /no_download
;
; iug_load_camera_omti_asi, /no_download
;
;13 /no_server
;
; iug_load_camera_omti_asi, /no_server
;
