...
;10 multi indices
;
; iug_load_gmag_wdc,site='asy sym ae dst wp'
;
...
; Modified by M. NOSE, Apr. 27, 2017 (nose at kugi.kyoto-u.ac.jp)
;-
...
;just spot checking cause there are a lot of data types
   ...
   print_tvar_info,'wdc_mag_Wp_index'
   if ~data_exists('wdc_mag_Wp_index',qa_timespan[0],qa_timespan[1]) $
   then message,'invalid load'
...
;just spot checking cause there are a lot of data types
   print_tvar_info,'wdc_mag_asy wdc_mag_sym wdc_mag_ae_prov_1min wdc_mag_dst_prov wdc_mag_Wp_index'
   if ~data_exists('wdc_mag_asy wdc_mag_sym wdc_mag_ae_prov_1min wdc_mag_dst_prov wdc_mag_Wp_index', $
                   qa_timespan[0],qa_timespan[1]) then message,'invalid load'
