;+
;function: tdexists_3d  (Modified for 3D data)
;
...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_8_00/tools/tplot/tdexists.pro $
;-

function tdexists_3d,tvarname,start_time,end_time,dims=dims
