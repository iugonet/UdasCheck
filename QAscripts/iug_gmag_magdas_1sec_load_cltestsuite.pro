...
;2 single site
;
; iug_load_gmag_magdas_1sec,site='onw'
;
...
;6 load all sites
;
; iug_load_gmag_magdas_1sec,site='all'
;
;7 load * sites
;
; iug_load_gmag_magdas_1sec,site='*'
;
;8 single datatype
;
; iug_load_gmag_magdas_1sec,datatype='1sec'
;
;9 caps datatype
;
; iug_load_gmag_magdas_1sec,datatype='1SEC'
...
;10 * datatype
;
; iug_load_gmag_magdas_1sec,datatype='*'
;
;11 array datatype
;
; iug_load_gmag_magdas_1sec,datatype=['1sec']
...
;12 verbose
;
; iug_load_gmag_magdas_1sec,site='ONW',/verbose
;
;13 /downloadonly
;
; iug_load_gmag_magdas_1sec,site='ONW',/downloadonly
;
;14 /no_download
; iug_load_gmag_magdas_1sec, /no_download
;
;
