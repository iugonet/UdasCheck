...
;2 single site
;
; iug_load_gmag_mm210,site='msr'
;
;3 multi sites string
;
; iug_load_gmag_mm210,site='msr rik'
;
;4 multi sites array
;
; iug_load_gmag_mm210,site=['msr','rik', 'ktb']
;
;5 caps site
;
; iug_load_gmag_mm210,site='MSR'
...
;6 load all sites
;
; iug_load_gmag_mm210,site='all'
;
;7 load * sites
;
; iug_load_gmag_mm210,site='*'
;
;8 single datatype
;
; iug_load_gmag_mm210,datatype='1min'
;
;9 caps datatype
;
; iug_load_gmag_mm210,datatype='1MIN'
...
;10 * datatype
;
; iug_load_gmag_mm210,datatype='*'
;
;11 array datatype
;
; iug_load_gmag_mm210,datatype=['1MIN', '1h']
;
;12 /downloadonly
;
;iug_load_gmag_mm210,site='msr',/downloadonly
;
;13 /no_download
;
; iug_load_gmag_mm210, /no_download
;
;
...
;;;13 valid_names
;;;
;;;iug_load_gmag_mm210,/valid_names,probe=testp,datatype=testd
;;;
;;
;;t_name='valid names'
;;
...
;;if err eq 0 then begin
;;
;;iug_load_gmag_mm210,site=sitep,datatype=testd,/valid_names
;;
...
;;;14 verbose
;;;
;;;iug_load_gmag_mm210,site='rik',/verbose
;;
;;t_name='verbose'
;;
;;catch,err
