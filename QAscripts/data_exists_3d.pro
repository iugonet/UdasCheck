;+
;function: data_exists_3d  (Modified for 3D data)
;
...
function data_exists_3d,tvarname,start_time,end_time,dims=dims

  compile_opt idl2

  ;function deprecated, calls duplicate version
  return,tdexists_3d(tvarname,start_time,end_time,dims=dims)
