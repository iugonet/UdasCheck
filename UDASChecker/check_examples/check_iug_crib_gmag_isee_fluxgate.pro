...
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_2_00/projects/erg/examples/erg_crib_gmag_stel_fluxgate.pro $
;-
...
makepng, 'iug_crib_gmag_isee_fluxgate_001'

; load 1 sec resolution data
iug_load_gmag_isee_fluxgate, site='msr kag', datatype='1sec'
...
makepng, 'iug_crib_gmag_isee_fluxgate_002'
