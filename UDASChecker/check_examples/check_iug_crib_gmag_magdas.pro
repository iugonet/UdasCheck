...
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_2_00/projects/erg/examples/erg_crib_gmag_magdas.pro $
;-
...
makepng, 'iug_crib_gmag_magdas_001'
