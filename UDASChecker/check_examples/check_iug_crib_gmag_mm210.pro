...
iug_load_gmag_mm210, site='msr rik', datatype='1min'
...
makepng, 'iug_crib_gmag_mm210_001'

; load 1 sec resolution data
iug_load_gmag_mm210, site='msr rik', datatype='1sec'
...
makepng, 'iug_crib_gmag_mm210_002'
